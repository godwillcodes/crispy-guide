    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="text-center max-w-2xl mx-auto mb-12">
        ...
        <p class="text-base text-gray-600">
          NBK Bancassurance Intermediary Limited has partnered with major insurers to offer your organization the best
          risk management advisory and insurance services in Kenya.
        </p>
      </div>
        ...
        <div
          ...
          <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
            <div class="text-center">
              ...
              <a href="#"
                class="inline-block px-4 py-2 border border-white hover:border-[#FFBA00] text-white text-xs rounded uppercase hover:bg-[#FFBA00] font-light hover:text-black">Learn
                More</a>
            </div>
          </div>
        </div>
